...
class Carbon extends DateTime
{
    ...
    public static function setLocale($locale)
    {
        ...
        static::translator()->addResource('array', require '/opt/lampp/htdocs/l5/laravel5-example/vendor/nesbot/carbon/src/Carbon' . '/Lang/' . $locale . '.php', $locale);
    }
...
class EventServiceProvider extends ServiceProvider
{
    protected $listen = array('auth.login' => array('App\\Services\\Statut@setLoginStatut'), 'auth.logout' => array('App\\Services\\Statut@setVisitorStatut'), 'user.access' => array('App\\Services\\Statut@setStatut'));
    public function boot(DispatcherContract $events)
    {
        parent::boot($events);
    }
